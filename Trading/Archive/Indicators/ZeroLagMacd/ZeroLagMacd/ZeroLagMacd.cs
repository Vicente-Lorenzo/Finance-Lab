...
namespace cAlgo.Indicators
{
    ...
    public class ZeroLagMacd : Indicator
    {
        ...
        protected override void Initialize()
        {
            ...
            _emaLong = Indicators.ExponentialMovingAverage(Bars.ClosePrices, LongCycle);
            _emaLong2 = Indicators.ExponentialMovingAverage(_emaLong.Result, LongCycle);

            _emaShort = Indicators.ExponentialMovingAverage(Bars.ClosePrices, ShortCycle);
