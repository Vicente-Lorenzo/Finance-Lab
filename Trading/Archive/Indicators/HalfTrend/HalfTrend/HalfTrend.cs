...
namespace cAlgo
{
    ...
    public class HalfTrend : Indicator
    {
        ...
        [Output("Up Line", LineColor = "SkyBlue", Thickness = 2, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries UpLine { get; set; }
        [Output("Down Line", LineColor = "Tomato", Thickness = 2, PlotType = PlotType.DiscontinuousLine)]
