...
namespace cAlgo.Robots
{
    ...
    public class KeltnerChannelsProStrategy : Robot
    {
        ...
        [Parameter("MA Period", Group = "Keltner Settings", DefaultValue = 20, MinValue = 1)]
        public int MaPeriod { get; set; }
        [Parameter("MA Type", Group = "Keltner Settings", DefaultValue = MovingAverageType.Simple)]
        public MovingAverageType MaType { get; set; }
        [Parameter("ATR Period", Group = "Keltner Settings", DefaultValue = 10, MinValue = 1)]
        ...
        [Parameter("Band Distance", Group = "Keltner Settings", DefaultValue = 2, MinValue = 1)]
        ...
        private KeltnerChannels _iKeltner;
        private ScheduleManager _schedule;
        private StrategyManager _strategyManager;

        protected override void OnStart()
        {
            _iKeltner = Indicators.KeltnerChannels(MaPeriod, MaType, AtrPeriod, AtrType, BandDistance);
        ...
        {
            return _schedule.IsOnSchedule() && Bars.OpenPrices.Last(1) < _iKeltner.Bottom.Last(1) && Bars.OpenPrices.Last(1) > Bars.ClosePrices.Last(2);
        }

        private bool SellTrigger(PositionManager position)
        {
            return _schedule.IsOnSchedule() && Bars.OpenPrices.Last(1) > _iKeltner.Top.Last(1) && Bars.OpenPrices.Last(1) < Bars.ClosePrices.Last(2);
        }
