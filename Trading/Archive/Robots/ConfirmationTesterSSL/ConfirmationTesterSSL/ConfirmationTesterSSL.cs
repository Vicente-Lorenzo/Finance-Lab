...
namespace cAlgo.Robots
{
    ...
    public class ConfirmationTesterSSL : Robot
    {
        // ==========================================================
        ...
        private CustomSSL iSSL { get; set; }
        private string TesterName = "SSLTester";
        // ==========================================================
        ...
        private void InitializeIndicators()
        {
            ...
            iSSL = Indicators.GetIndicator<CustomSSL>(Bars.HighPrices, Bars.LowPrices, Bars.ClosePrices, Period, MAType);
        }
        // ==========================================================
        ...
        {
            return barUpdate && PosManager.HasNoActivePosition() && iSSL.UpLine.Last(1) > iSSL.DownLine.Last(1) && iSSL.DownLine.Last(2) > iSSL.UpLine.Last(2);
        }

        private bool NormalSellTrigger(bool barUpdate)
        {
            return barUpdate && PosManager.HasNoActivePosition() && iSSL.DownLine.Last(1) > iSSL.UpLine.Last(1) && iSSL.UpLine.Last(2) > iSSL.DownLine.Last(2);
        }
        ...
        private bool NormalExitTrigger(bool barUpdate)
        {
            ...
            return (ttype == TradeType.Buy && iSSL.DownLine.Last(1) > iSSL.UpLine.Last(1) && iSSL.UpLine.Last(2) > iSSL.DownLine.Last(2)) || (ttype == TradeType.Sell && iSSL.UpLine.Last(1) > iSSL.DownLine.Last(1) && iSSL.DownLine.Last(2) > iSSL.UpLine.Last(2));
        }
        // ==========================================================
