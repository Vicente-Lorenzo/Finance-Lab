...
public class StrategyDownload : Robot
{
    ...
    protected override void OnStart() { _strategy = new Download(this, Console, Telegram); }
...
public class Download : Strategy { public Download(Robot robot, Logging.VerboseType console, Logging.VerboseType telegram) : base(robot, console, telegram) { } }
