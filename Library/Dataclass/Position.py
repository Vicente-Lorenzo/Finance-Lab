...
class PositionAPI(DataclassAPI):
    ...
    EntryTimestamp: InitVar[datetime] = field(init=True, repr=True)

    EntryPrice: InitVar[float] = field(init=True, repr=True)
    StopLossPrice: InitVar[float] = field(default=None, init=True, repr=True)
    TakeProfitPrice: InitVar[float] = field(default=None, init=True, repr=True)
    MaxRunUpPrice: InitVar[float] = field(default=None, init=True, repr=True)
    MaxDrawDownPrice: InitVar[float] = field(default=None, init=True, repr=True)
    ExitPrice: InitVar[float] = field(init=True, repr=True)

    StopLossPnL: InitVar[float] = field(default=None, init=True, repr=True)
    TakeProfitPnL: InitVar[float] = field(default=None, init=True, repr=True)
    MaxRunUpPnL: InitVar[float] = field(default=None, init=True, repr=True)
    MaxDrawDownPnL: InitVar[float] = field(default=None, init=True, repr=True)
    GrossPnL: InitVar[float] = field(init=True, repr=True)
    CommissionPnL: InitVar[float] = field(init=True, repr=True)
    SwapPnL: InitVar[float] = field(init=True, repr=True)
    NetPnL: InitVar[float] = field(init=True, repr=True)

    UsedMargin: float = field(default=None, init=True, repr=True)
    EntryBalance: InitVar[float] = field(default=None, init=True, repr=True)
