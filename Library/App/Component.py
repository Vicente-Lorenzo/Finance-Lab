...
def parse_classname(basename: str = None, classname: str = None) -> str:
    basename: str = basename or ""
    classname: str = classname or ""
    return f"{basename} {classname}".strip()
...
class ComponentAPI(Component, ABC):
    ...
    def __post_init__(self):
        ...
        self.classname = parse_classname(basename=self.basename, classname=self.classname)
...
class IconAPI(ComponentAPI):
    ...
    def build(self) -> Component:
        return html.I(**self.arguments(), children=self.icon)
...
class ButtonAPI(ComponentAPI):
    ...
    def build(self) -> Component:
        return dbc.Button(**self.arguments())
...
class PaginatorAPI(ButtonContainerAPI):
    ...
    def __post_init__(self):
        ...
        external = ButtonAPI(
            ...
            external=True,
            classname="external bi bi-box-arrow-up-right"
        )
