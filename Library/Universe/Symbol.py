...
from Library.Portfolio.Account import AssetType
if TYPE_CHECKING: from Library.Market.Tick import TickAPI
...
class SymbolAPI(DataclassAPI):
    ...
    def AskUnitValue(self) -> float:
        return 1.0 * self._spot_tick_.AskBaseConversion
    @property
    def BidUnitValue(self) -> float:
        return 1.0 * self._spot_tick_.BidBaseConversion
    @property
    def AskLotValue(self) -> float:
        return self.LotSize * self._spot_tick_.AskBaseConversion
    @property
    def BidLotValue(self) -> float:
        return self.LotSize * self._spot_tick_.BidBaseConversion

    @property
    def AskPointValue(self) -> float:
        return self.PointSize * self.LotSize * self._spot_tick_.AskQuoteConversion
    @property
    def BidPointValue(self) -> float:
        return self.PointSize * self.LotSize * self._spot_tick_.BidQuoteConversion
    @property
    def AskPipValue(self) -> float:
        return self.PipSize * self.LotSize * self._spot_tick_.AskQuoteConversion
    @property
    def BidPipValue(self) -> float:
        return self.PipSize * self.LotSize * self._spot_tick_.BidQuoteConversion

    @property
    def SpotTick(self) -> TickAPI:
        return self._spot_tick_
    @SpotTick.setter
    def SpotTick(self, spot_tick: TickAPI):
        self._spot_tick_ = spot_tick
