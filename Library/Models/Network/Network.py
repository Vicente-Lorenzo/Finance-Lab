...
class NetworkAPI(nn.Module, ABC):
    ...
    def __init__(self,
        ...
        self._filename = ParametersAPI.PATH / broker / group / symbol / timeframe / f"DDPG_{name}"
    ...
    def save(self):
        ...
        self._console.debug(lambda: "Saved network state")

    def load(self):
        self.load_state_dict(T.load(self.checkpoint_file))
        self._console.debug(lambda: "Loaded network state")
